...
const styles = StyleSheet.create({
  ...
  inviteInput: { flex: 1, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 10, fontSize: 14 },
  inviteBtn: { paddingHorizontal: 16, borderRadius: 10, justifyContent: 'center' },
  groupItem: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
